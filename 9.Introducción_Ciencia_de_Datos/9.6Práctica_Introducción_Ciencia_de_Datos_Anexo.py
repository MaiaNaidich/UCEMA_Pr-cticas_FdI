...
pers=pd.DataFrame()
pers["persona_id"]=personas["persona_id"]
pers["anio"]=personas["anio"]
pers["categoria_conicet_id"]=personas["categoria_conicet_id"]
pers

#Otra forma de hacerlo (hecho por el profesor)
pers_profesor=pd.concat([personas["persona_id"],personas["anio"],personas["categoria_conicet_id"]],axis=1)
pers_profesor
